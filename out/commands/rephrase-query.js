...
exports.rephraseQuery = rephraseQuery;
const vscode = __importStar(require("vscode"));
function rephraseQuery(context) {
    const disposable = vscode.commands.registerCommand('extension-plop.rephrase-query', () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch('https://simpliq-backend-dem.bdp.wdc.com/rephrase_query', {
                method: 'POST',
