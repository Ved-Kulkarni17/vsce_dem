...
export function getUnstructured(context: vscode.ExtensionContext) {
  const disposable = vscode.commands.registerCommand('extension-plop.get-unstructured', async () => {
    ...
    try {
      ...
      const response = await fetch('https://simpliq-backend-dem.bdp.wdc.com/get_dataframe', {
        method: 'POST',
